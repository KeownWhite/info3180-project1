...
class ProfileForm(FlaskForm):
    firstname = StringField('First Name', validators=[DataRequired('Please provide a firstnam')])
    ...
    location = StringField('State, Country',validators=[DataRequired('Please enter a location')])
